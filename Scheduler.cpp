...
Scheduler::Scheduler(int cores, CPU::Algorithm algorithm, ProcessQueue process_queue, std::shared_mutex& process_map_lock, long long int quantum_cycles, long long int delay_per_exec, CPUClockSource& cpuClockSource) :
num_cores(cores),
algorithm(algorithm),
...
void Scheduler::runScheduler()
{
	...
	{
		auto cpu = std::make_shared<CPU>(cpu_core_id, this->algorithm, this->process_queue, this->process_map_lock, this->quantum_cycles, this->delay_per_exec, this->cpuClockSource.getSemaphores(cpu_core_id));
