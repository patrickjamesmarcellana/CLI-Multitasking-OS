...
void Scheduler::runScheduler()
{
	...
	{
		this->cpu_cores.push_back(std::make_shared<CPU>(cpu_core_id, this->algorithm, this->process_queue, this->delay_per_exec, this->cpuClockSource.getSemaphores(cpu_core_id)));
	}
}
